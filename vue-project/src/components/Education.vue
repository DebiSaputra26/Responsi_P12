...
<template>
<section id="Mahasiswa" class="py-20 bg-white">
<div class="container mx-auto px-6">
<SectionTitle title="Mahasiswa" />
<div class="relative">
...
<div class="w-1/2 pr-8 text-right"><p class="font-semibold text-red-600">{{ edu.period

}}</p><h3 class="text-2xl font-bold text-gray-800">{{ edu.institution }}</h3><p class="text-gray-
600">{{ edu.major }}</p></div>

<div class="w-1/2 flex justify-start"><div class="w-4 h-4 bg-red-600 rounded-full z-
10"></div></div>
...
<div class="w-1/2 flex justify-end"><div class="w-4 h-4 bg-red-600 rounded-full z-
10"></div></div>

<div class="w-1/2 pl-8 text-left"><p class="font-semibold text-red-600">{{ edu.period
