...
<div class="mb-4">
<span v-for="t in project.tech" :key="t" class="inline-block bg-red-100 text-red-800 text-sm
font-semibold mr-2 mb-2 px-2.5 py-0.5 rounded-full">{{ t }}</span>
</div>

<a :href="project.link" target="_blank" rel="noopener noreferrer" class="text-red-600 font-
