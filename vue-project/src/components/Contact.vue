...
<a href="mailto:emailanda@example.com" class="bg-red-600 text-white font-bold py-3 px-6rounded-lg hover:bg-red-700 transition-colors duration-300 inline-block mb-12">Kirim Email</a>
